...
2.  **Two-Factor Authorization:** Every request requires a **Sanctum Bearer Token** (user authentication) and an **X-Interface-Key** (application authorization) found in the `interfaces` table.

 ...
 *
 * This class extends BaseGameState and adds Connect Four-specific state
...
final class ConnectFourBoard extends BaseGameState
{
     ...
     *
     * @param  array<string, ConnectFourPlayer>  $players  Map of player ULID to ConnectFourPlayer
     ...
     * Example:
     * ```php
     * $gameState = ConnectFourConnectFourBoard::createNew(
    ...
    public static function createNew(
        ...
        $players = [
            $playerOneUlid => new ConnectFourPlayer(
                ulid: $playerOneUlid,
                position: 1,
                color: 'red'
            ),
            $playerTwoUlid => new ConnectFourPlayer(
                ulid: $playerTwoUlid,
                position: 2,
                color: 'yellow'
            ),
    ...
    public static function fromArray(array $stateData): static
    {
        ...
        foreach ($stateData['players'] ?? [] as $ulid => $playerData) {
            $players[$ulid] = ConnectFourPlayer::fromArray($playerData);
        }

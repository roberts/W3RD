...
use App\GameTitles\BasePlayerState;

/**
 * Player state for Connect Four games.
 *
 * Contains player-specific information for a Connect Four game instance.
 * Immutable - use withX() methods to create modified copies.
 */
class ConnectFourPlayer extends BasePlayerState
{
    /**

...
namespace App\GameTitles\ConnectFour\Enums;

/**
 * Error codes specific to ConnectFour (Connect Four) game logic.
 *
 * These codes represent rule violations unique to ConnectFour gameplay.
 * Use BaseGameActionErrorCode for universal game state errors.
 */
enum ConnectFourActionError: string
{
    /**

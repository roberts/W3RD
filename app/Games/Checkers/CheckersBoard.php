 ...
 * ```
 */
final class CheckersBoard extends BaseGameState
{
    /**
     ...
     *
     * @param  array<string, CheckersPlayer>  $players  Map of player ULID to CheckersPlayer
    ...
    public static function createNew(string $playerOneUlid, string $playerTwoUlid): self
    {
        ...
        $players = [
            $playerOneUlid => new CheckersPlayer($playerOneUlid, 'red', 12),
            $playerTwoUlid => new CheckersPlayer($playerTwoUlid, 'black', 12),
        ];
    ...
    public static function fromArray(array $data): static
    {
        ...
        foreach ($data['players'] ?? [] as $ulid => $playerData) {
            $players[$ulid] = CheckersPlayer::fromArray($playerData);
        }
    ...
    public function withMovedPiece(int $fromRow, int $fromCol, int $toRow, int $toCol): self
    {
        ...
        if ($piece !== null) {
            ...
            /** @var CheckersPlayer $playerState */

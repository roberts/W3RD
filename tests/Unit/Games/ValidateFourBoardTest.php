...
describe('ValidateFour ValidateFourBoard', function () {
    beforeEach(function () {
    ...
    describe('Factory Methods', function () {
        test('createNew initializes valid game state', function () {
            $state = ValidateFourBoard::createNew(
                $this->player1Ulid,
                $this->player2Ulid,
                columns: 7,
                rows: 6,
    ...
    describe('Serialization', function () {
        ...
        test('fromArray reconstructs state from array', function () {
            $original = ValidateFourBoard::createNew($this->player1Ulid, $this->player2Ulid);
            $array = $original->toArray();

            $restored = ValidateFourBoard::fromArray($array);
        ...
        test('fromArray handles missing optional fields with defaults', function () {
            ...
            $state = ValidateFourBoard::fromArray($minimal);
        ...
        test('serialization roundtrip preserves all data', function () {
            ...
            $restored = ValidateFourBoard::fromArray($original->toArray());

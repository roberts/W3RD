...
class Container_0053ea1e0a extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_0053ea1e0a $container)
			{
	...
	public function createServiceContainer(): Container_0053ea1e0a
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/og5qapeufd9u5NPhGJj|1|*|*|/etc/php/php.ini:/etc/php/conf.d/xdebug.ini|3.4.5',

...
class Container_31e715338b extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService061(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				[
					'message' => '#Method App\\\Actions\\\Fortify\\\(CreateNewUser|ResetUserPassword)::passwordRules\(\) should return array.*#',
					'path' => '/home/drewroberts/Code/protocol/app/Actions/Fortify/PasswordValidationRules.php',
				],
				[
					'message' => '#Access to an undefined property App\\\Games\\\BaseGameState::\$board#',
					'path' => '/home/drewroberts/Code/protocol/app/Games/BaseBoardGameTitle.php',
				],
				...
				'#Property App\\\Models\\\Game\\\Game::\$status.*does not accept.*completed#',
				...
				[
					...
					'path' => '/home/drewroberts/Code/protocol/app/Games/ValidateFour/GameState.php',
				],
			],
			true
		);
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_31e715338b $container)
			{
	...
	public function createServiceContainer(): Container_31e715338b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'HL_INITIAL_WORKSPACE_TOKEN' => '7cd138fd-b19c-4e2b-a311-51ffdbb01c3e',
				'NO_AT_BRIDGE' => '1',
				'XCURSOR_SIZE' => '24',
				'EDITOR' => 'nvim',
				'XDG_SEAT' => 'seat0',
				...
				'__MISE_SESSION' => 'eAFrX5OTn5iSmhJfkp+fUzxhHZSXnJ+XlplePPGmln5Gfm6qfkpRanlRflJqUUmxvh5EUj83szhVH8LWK8nPzVkDYccXJJZkFE9YnJpX1rA4JbNoP6YJzvkpqfoFRfkl+cn5OWtS88riyxKL4jMSizM2JBlbGqammRokmRsmG5pamK3NSSxJLS6JLy1ISSxJPSLAAAeMs/pqjaIAvmJJjg',
				...
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/n39shii1r4cc9GMZymj|1|*|*|/etc/php/php.ini:/etc/php/conf.d/xdebug.ini|3.4.5',

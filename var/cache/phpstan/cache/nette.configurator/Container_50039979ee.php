...
class Container_50039979ee extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_50039979ee $container)
			{
	...
	public function createServiceContainer(): Container_50039979ee
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/elft52v34a0d1quQ57P|1|*|*|/etc/php/php.ini:/etc/php/conf.d/xdebug.ini|3.4.5',

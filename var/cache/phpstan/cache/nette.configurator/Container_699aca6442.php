...
class Container_699aca6442 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_699aca6442 $container)
			{
	...
	public function createServiceContainer(): Container_699aca6442
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/dcl2pr9denk36yPC0Ay|1|*|*|/etc/php/php.ini:/etc/php/conf.d/xdebug.ini|3.4.5',

...
class Container_6a4204fb2b extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_6a4204fb2b $container)
			{
	...
	public function createServiceContainer(): Container_6a4204fb2b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/banmomb4i5gu0Em1Fii|1|*|*|/etc/php/php.ini:/etc/php/conf.d/xdebug.ini|3.4.5',

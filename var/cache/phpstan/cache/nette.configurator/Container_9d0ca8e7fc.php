...
class Container_9d0ca8e7fc extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_9d0ca8e7fc $container)
			{
	...
	public function createServiceContainer(): Container_9d0ca8e7fc
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/ajc83hvlssoa60TTrDW|1|*|*|/etc/php/php.ini:/etc/php/conf.d/xdebug.ini|3.4.5',

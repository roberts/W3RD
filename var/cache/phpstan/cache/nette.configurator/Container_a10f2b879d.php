...
class Container_a10f2b879d extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a10f2b879d $container)
			{
	...
	public function createServiceContainer(): Container_a10f2b879d
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/4fk17es6talleCdBsGY|1|*|*|/etc/php/php.ini:/etc/php/conf.d/xdebug.ini|3.4.5',

...
class Container_d1ec045e84 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService061(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				'#No error with identifier .* is reported on line#',
			],
			true
		);
	}
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_d1ec045e84 $container)
			{
	...
	public function createServiceContainer(): Container_d1ec045e84
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/1ah5nlf4qgj9ceMMFJ8|1|*|*|/etc/php/php.ini:/etc/php/conf.d/xdebug.ini|3.4.5',

...
class Container_efec565925 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_efec565925 $container)
			{
	...
	public function createServiceContainer(): Container_efec565925
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/nuqr66t72hvgdNhwyKY|1|*|*|/etc/php/php.ini:/etc/php/conf.d/xdebug.ini|3.4.5',

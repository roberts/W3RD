...
class Container_f84de0e175 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_f84de0e175 $container)
			{
	...
	public function createServiceContainer(): Container_f84de0e175
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/9itm0erg3t32aQ0I64l|1|*|*|/etc/php/php.ini:/etc/php/conf.d/xdebug.ini|3.4.5',
